# -*- coding: utf-8 -*-
#
# webhook2lambda2sqs documentation build configuration file, created by
...
from webhook2lambda2sqs.version import _VERSION
...
if is_rtd:
    ...
    htmlhelp_basename = 'webhook2lambda2sqsdoc'
...
latex_documents = [
  (master_doc, 'webhook2lambda2sqs.tex', u'webhook2lambda2sqs Documentation',
...
man_pages = [
    (master_doc, 'webhook2lambda2sqs', u'webhook2lambda2sqs Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'webhook2lambda2sqs', u'webhook2lambda2sqs Documentation',
   author, 'webhook2lambda2sqs', 'One line description of project.',
   'Miscellaneous'),
]
